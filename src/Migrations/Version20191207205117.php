 ...
 */
final class Version20191207205117 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE venteshowroom ADD modereglement VARCHAR(255) NOT NULL, DROP stockshowroom_id, DROP modereglement_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE modereglement (id INT AUTO_INCREMENT NOT NULL, edited_by_id INT DEFAULT NULL, created_by_id INT DEFAULT NULL, libelle VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, slug VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, edited_on DATETIME NOT NULL, created_on DATETIME NOT NULL, INDEX IDX_C643F0B7B03A8386 (created_by_id), INDEX IDX_C643F0B7DD7B2EBC (edited_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE venteshowroom ADD stockshowroom_id INT DEFAULT NULL, ADD modereglement_id INT NOT NULL, DROP modereglement');
